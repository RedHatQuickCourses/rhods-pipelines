...
This course is the last in a series of five courses about Red Hat OpenShift AI (RHOAI). This course teaches you how to automate the lifecycle of machine learning models using Data Science Pipelines.
...
```
    $ git clone git@github.com:RedHatQuickCourses/rhods-pipelines.git
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/rhods-pipelines

# Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/rhods-pipelines/issues
